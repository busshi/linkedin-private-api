...
*Defined in [src/entities/linkedin-vector-image.entity.ts:4](https://github.com/busshi/linkedin-private-api/blob/f1b6b7b/src/entities/linkedin-vector-image.entity.ts#L4)*
...
*Defined in [src/entities/linkedin-vector-image.entity.ts:5](https://github.com/busshi/linkedin-private-api/blob/f1b6b7b/src/entities/linkedin-vector-image.entity.ts#L5)*
...
*Defined in [src/entities/linkedin-vector-image.entity.ts:6](https://github.com/busshi/linkedin-private-api/blob/f1b6b7b/src/entities/linkedin-vector-image.entity.ts#L6)*
